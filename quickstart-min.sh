...
clear
sudo apt-fast install xfce4-power-manager git lightdm-gtk-greeter-settings tumbler smplayer mpd mpv youtube-dl synaptic obconf lxrandr eject bash-completion gvfs* qt5-style-plugins qt5ct openbox compton package-update-indicator network-manager network-manager-gnome xinit epiphany-browser pcmanfm mousepad lxterminal xfce4-screenshooter lxappearance pulseaudio alsa-utils xfce4-notifyd pavucontrol file-roller ristretto gmrun xserver-xorg xdg-user-dirs wpasupplicant htop xfce4-panel xfce4-pulseaudio-plugin xfce4-whiskermenu-plugin arc-theme desktop-base cantata xscreensaver --no-install-recommends --no-install-suggests -y
