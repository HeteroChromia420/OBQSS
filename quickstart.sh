...
echo "if you're running devuan, you'll need to install libpam-elogind before running this script. if you aren't sure, run sudo apt install libpam-elogind before running this script."
read -n 1 -s
clear
...
sudo apt-get install  policykit-1-gnome lxsession-logout
clear
