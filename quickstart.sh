...
clear
sudo apt-fast install gvfs* qt5-style-plugins qt5ct openbox tint2 nitrogen compton pnmixer package-update-indicator cmst xinit firefox-esr slim thunar scite xfce4-terminal xfce4-screenshooter lxappearance pulseaudio alsa-utils dunst pavucontrol egrampa ristretto htop conky gmrun
