...
clear
sudo apt-fast install menu gvfs* qt5-style-plugins qt5ct openbox tint2 nitrogen compton pnmixer package-update-indicator cmst xinit firefox-esr slim thunar scite xfce4-terminal xfce4-screenshooter lxappearance pulseaudio alsa-utils dunst pavucontrol engrampa ristretto htop conky gmrun smplayer gimp libreoffice
