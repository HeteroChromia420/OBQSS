...
clear
sudo apt-fast install gvfs* qt5-style-plugins qt5ct openbox xfce4-panel xfce4-whiskermenu-plugin pnmixer nitrogen compton package-update-indicator cmst xinit firefox-esr slim pcmanfm scite xfce4-terminal xfce4-screenshooter lxappearance pulseaudio alsa-utils dunst pavucontrol engrampa ristretto htop gmrun -y
