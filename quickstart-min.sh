...
clear
sudo apt-fast install gvfs* qt5-style-plugins qt5ct openbox tint2 pnmixer nitrogen compton package-update-indicator cmst xinit firefox-esr pcmanfm scite rxvt-unicode xfce4-screenshooter lxappearance lxtask pulseaudio alsa-utils dunst pavucontrol file-roller ristretto htop gmrun xserver-xorg xdg-user-dirs  --no-install-recommends --no-install-suggests -y
mkdir ~/.config
