...
clear
sudo apt-fast install desktop-base gvfs* qt5-style-plugins qt5ct openbox xfce4-panel xfce4-pulseaudio-plguin xfce4-whiskermenu-plugin nitrogen compton package-update-indicator cmst xinit firefox-esr lightdm thunar scite xfce4-terminal xfce4-screenshooter lxappearance pulseaudio alsa-utils xfce4-notifyd pavucontrol file-roller ristretto htop conky gmrun smplayer gimp libreoffice
