...
clear
sudo apt-fast install epiphany-browser gvfs* eject git lxappearance qt5ct qt5-gtk2-platformtheme htop obconf openbox tint2 pnmixer nitrogen network-manager network-manager-gnome xinit pcmanfm scite lxterminal pulseaudio alsa-utils dunst pavucontrol vim openbox-menu xserver-xorg xdg-user-dirs wpasupplicant preload zram-tools --no-install-recommends --no-install-suggests -y
