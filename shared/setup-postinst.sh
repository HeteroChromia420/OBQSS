...
#This script should only be used on systems with OBQSS's base system installed. this only copies the themes and configurations to the home folder of this user.
